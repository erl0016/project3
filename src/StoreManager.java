...
public class StoreManager {
    ...
    public static final String DB_FILE = "E:\\Classes\\COMP 3700\\Database\\DB_StoreManager.db";
    ...
    public static void checkServer() {
        try {
            StoreServer.main(new String[] {"1000", DB_FILE});
        }
        catch (Exception ex) {
            //handle if server is still live
        }
    }
}
